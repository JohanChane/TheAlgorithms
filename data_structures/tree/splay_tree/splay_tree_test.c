...
static void testSplayTree() {
    ...
    for (int k = 0; k < ARRAY_SIZE; k++) {
        // printf("before splay: splayTree->element = %d, element = %d\n", splayTree->element, array[k]);
        splayTree = splayTreeSplay(array[k], splayTree);
        // printf("after splay: splayTree->element = %d, element = %d\n", splayTree->element, array[k]);
        // if (splayTree->element != array[k]) {
        //     printSplayTree(splayTree);
        //     fprintf(stderr, "splayTreeSplay failed.\n");
        //     exit(EXIT_FAILURE);
        // }
    }
